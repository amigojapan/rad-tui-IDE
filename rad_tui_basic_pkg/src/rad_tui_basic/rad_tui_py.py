...
# ==========================================================
# VB1-DOS Clone: Python curses IDE (Internationalization & IME)
# ==========================================================
...
I18N = {
    'en': {
        'toolbox_title': '-Tools-',
        'tools': ["Move/Size", "Check Box", "Combo Box", "Command Btn", "Frame", "HScrollBar", "Label", "List Box", "Option Btn", "Text Box", "Timer", "VScrollBar"],
        'prop_title': 'Properties',
        'prop_no_sel': 'No selection.',
        'prop_type': 'Type: {}',
        'prop_form': 'Form',
        'prop_name': 'Name:',
        'prop_cap': 'Cap: ',
        ...
        'prop_min': 'Min:  ',
        'prop_max': 'Max:  ',
        'prop_hscroll': 'HScroll:',
        'prop_vscroll': 'VScroll:',
        'prop_syntaxhl': 'SyntaxHL:',
        'prop_edit': 'Editable:',
        'prop_color': 'Color:',
        'prop_pinned': 'Pinned:',
        'prop_resiz': 'Resiz:',
        ...
        'prop_fg': 'FGColor:',
        'prop_bg': 'BGColor:',
        'menu_top': ' File  Edit  [RUN ] Menu Editor ',
        'menu_top_run': ' [STOP] ',
        'menu_file': [" Save Project       ", " Save Project As... ", " Load Project...    ", " Exit IDE           "],
        'menu_edit': [" Delete Selected Control "],
        'msg_saved': 'Project saved to {}',
        'msg_loaded': 'Project loaded from {}',
        'msg_save_err': 'Save Error:\n{}',
        'msg_load_err': 'Load Error:\n{}',
        'msg_sel_file': 'Please select a file.',
        'me_title': 'Menu Editor',
        'me_sel': 'Selected Menu',
        'me_add_top': 'Add Top Menu',
        'me_add_sub': 'Add Sub Menu',
        'me_del_sel': 'Delete Selected',
        'me_del_menu': 'Delete Menu',
        'me_edit_code': 'Edit Code',
        'me_close': 'Close Editor',
        'me_ok': 'OK',
        'me_lbl_sel': 'Selected Menu:',
        'me_p_top': 'Top Menu Label:',
        'me_p_func': 'Func (e.g. mnu_file):',
        'me_p_sub': 'Sub-Menu Label:',
        'me_p_sfunc': 'Function Name:',
        'ctx_copy': 'Copy',
        'ctx_paste': 'Paste',
        'ctx_sel_all': 'Select All',
        'untitled': 'untitled',
        'ctrl_button': 'Button',
        'ctrl_frame': 'Frame1',
        'ctrl_check': 'Check1',
    ...
    'es': {
        'toolbox_title': '-Herr.-',
        'tools': ["Mover/Tam", "Casilla", "Desplegable", "Boton Cmd", "Marco", "BarrDespl H", "Etiqueta", "Lista", "Opcion", "Texto", "Temp.", "BarrDespl V"],
        'prop_title': 'Propiedades',
        'prop_no_sel': 'Sin seleccion.',
        'prop_type': 'Tipo: {}',
        'prop_form': 'Formulario',
        'prop_name': 'Nombr:',
        'prop_cap': 'Texto:',
        'prop_x': 'X:   ',
        'prop_y': 'Y:   ',
        ...
        'prop_fg': 'Color T:',
        'prop_bg': 'Color F:',
        'menu_top': ' Archivo  Editar  [EJECUTAR ] Editor de Menus ',
        'menu_top_run': ' [DETENER] ',
        'menu_file': [" Guardar Proyecto       ", " Guardar Proyecto Como... ", " Cargar Proyecto...    ", " Salir del IDE           "],
        'menu_edit': [" Borrar Control Seleccionado "],
        'msg_saved': 'Proyecto guardado en {}',
        'msg_loaded': 'Proyecto cargado desde {}',
        'msg_save_err': 'Error de guardado:\n{}',
        'msg_load_err': 'Error de carga:\n{}',
        'msg_sel_file': 'Por favor seleccione un archivo.',
        'me_title': 'Editor de Menus',
        'me_sel': 'Menu Seleccionado',
        'me_add_top': 'Anadir Menu Princ',
        'me_add_sub': 'Anadir Submenu',
        'me_del_sel': 'Borrar Seleccion',
        'me_del_menu': 'Borrar Menu',
        'me_edit_code': 'Editar Codigo',
        'me_close': 'Cerrar Editor',
        'me_ok': 'Aceptar',
        'me_lbl_sel': 'Menu Selecc:',
        'me_p_top': 'Etiqueta de Menu Princ:',
        'me_p_func': 'Funcion (ej. mnu_arch):',
        'me_p_sub': 'Etiqueta de Submenu:',
        'me_p_sfunc': 'Nombre de Funcion:',
        'ctx_copy': 'Copiar',
        'ctx_paste': 'Pegar',
        'ctx_sel_all': 'Sel. Todo',
        'untitled': 'sin titulo',
        'ctrl_button': 'Boton',
        'ctrl_frame': 'Marco1',
        'ctrl_check': 'Casilla1',
    ...
    'jp': {
        'toolbox_title': '-ツール-',
        'tools': ["移動/ｻｲｽﾞ", "ﾁｪｯｸﾎﾞｯｸｽ", "ｺﾝﾎﾞﾎﾞｯｸｽ", "ｺﾏﾝﾄﾞﾎﾞﾀﾝ", "ﾌﾚｰﾑ", "水平ｽｸﾛｰﾙ", "ﾗﾍﾞﾙ", "ﾘｽﾄﾎﾞｯｸｽ", "ｵﾌﾟｼｮﾝ", "ﾃｷｽﾄﾎﾞｯｸｽ", "ﾀｲﾏｰ", "垂直ｽｸﾛｰﾙ"],
        'prop_title': 'プロパティ',
        'prop_no_sel': '選択なし',
        'prop_type': '種類: {}',
        'prop_form': 'ﾌｫｰﾑ',
        ...
        'prop_fg': '文字色:',
        'prop_bg': '背景色:',
        'menu_top': ' ファイル  編集  [実行 ] メニューエディタ ',
        'menu_top_run': ' [停止] ',
        'menu_file': [" プロジェクト保存   ", " 名前を付けて保存... ", " プロジェクト開く...  ", " IDEを終了する      "],
        'menu_edit': [" 選択したコントロールを削除 "],
        'msg_saved': '{} に保存しました',
        'msg_loaded': '{} から読込ました',
        'msg_save_err': '保存エラー:\n{}',
        'msg_load_err': '読込エラー:\n{}',
        'msg_sel_file': 'ファイルを選択してください。',
        'me_title': 'メニューエディタ',
        'me_sel': '選択メニュー',
        'me_add_top': 'トップメニュー追加',
        'me_add_sub': 'サブメニュー追加',
        'me_del_sel': '選択項目を削除',
        'me_del_menu': 'メニューを削除',
        'me_edit_code': 'コードを編集',
...
class Window:
    def __init__(self, x, y, w, h, title="", name_id="Form1"):
        if not title: title = _t('untitled')
        self.x, self.y, self.w, self.h = x, y, w, h
    ...
    @classmethod
    def from_dict(cls, data):
        w = cls(data['x'], data['y'], data['w'], data['h'], data.get('title', _t('untitled')), data.get('name_id', 'Form1'))
    ...
    def add_control(self, cx, cy, ctype, ctitle):
        if len(self.controls) < 30:
            ...
            if ctype == 3: ctrl = UIControl(cx, cy, 12, 3, ctype, name_id, _t('ctrl_button'))
            elif ctype == 13: ctrl = UIControl(cx, cy, 15, 3, ctype, name_id, "")
            elif ctype == 7: ctrl = UIControl(cx, cy, 20, 8, ctype, name_id, _t('ctrl_frame'))
            elif ctype == 1: ctrl = UIControl(cx, cy, 15, 1, ctype, name_id, _t('ctrl_check'))
            elif ctype == 11: ctrl = UIControl(cx, cy, 15, 1, ctype, name_id, _t('ctrl_option'))
            elif ctype == 2:
                ctrl = UIControl(cx, cy, 15, 1, ctype, name_id, _t('ctrl_combo'))
                ctrl.items = ["Item 1", "Item 2", "Item 3"]
            elif ctype == 10:
                ctrl = UIControl(cx, cy, 15, 4, ctype, name_id, _t('ctrl_list'))
                ctrl.items = ["Item 1", "Item 2", "Item 3", "Item 4", "Item 5"]
            elif ctype == 14: ctrl = UIControl(cx, cy, 10, 1, ctype, name_id, _t('ctrl_timer'))
            elif ctype == 8: 
    ...
    def draw(self, stdscr, colors, active_ctrl=-1, pressed_ctrl=-1, run_mode=False):
        ...
        tx = self.x + (self.w // 2) - (d_len(title_str) // 2)
        write_clipped_raw(stdscr, tx, self.y, title_str, C_BORDER, self.x, self.w)

        def write_clipped(cx, cy, text, attr):
            if cy <= self.y or cy >= self.y + self.h - 1: return
            write_clipped_raw(stdscr, cx, cy, text, attr, self.x + 1, self.w - 2)
        ...
        for i, c in enumerate(self.controls):
            ...
            if c.tool_type == 3: 
                ...
                for r in range(1, actual_h - 1):
                    ...
                    if r == actual_h // 2:
                        pad = (c.w - 2 - d_len(c.caption)) // 2
                        if is_pressed: pad += 1 
                        text = d_pad(" " * max(0, pad) + c.caption, c.w - 2)
                ...
                for r in range(vh):
                    ...
                    if actual_y < len(lines):
                        ...
                        curr_x, str_disp_w = draw_x, 0
                        for col, char in enumerate(line_text):
                            if col < c.scroll_x: 
                                str_disp_w += d_len(char)
                                continue
                            if str_disp_w >= vw: break
                            
                            actual_x = col
                            attr = char_attrs[col]
                            if is_selected(actual_y, actual_x, c.sel_start, c.sel_end): attr = attr | curses.A_REVERSE
                        ...
                        if str_disp_w < vw:
                            pad_len = vw - str_disp_w
                            for padding_idx in range(pad_len):
                                attr = c_attr
                                actual_x = len(line_text) + padding_idx
                                if is_selected(actual_y, actual_x, c.sel_start, c.sel_end): attr = attr | curses.A_REVERSE
                ...
                if c.h_scroll:
                    max_len = max([d_len(l) for l in lines] + [0])
                    for col in range(vw):
                        char = "▒"
                        if max_len > vw:
                ...
                write_clipped(draw_x, draw_y, d_pad("[⏱] " + c.name_id, c.w), c_attr)
                ...
                cap_str = f" {c.caption} "
                if d_len(cap_str) <= c.w - 2: write_clipped(draw_x + 2, draw_y, cap_str, C_BORDER)
                    
            elif c.tool_type == 1: 
                for r in range(c.h):
                    if r == 0:
                        mark = "X" if c.value else " "
                        text = d_pad(f"[{mark}] {c.caption}", c.w)
...
class Toolbox:
    def __init__(self, x, y):
        ...
        self.active_tool = 0
        self.tools = [
            (0, _t('tools')[0]), (1, _t('tools')[1]), (2, _t('tools')[2]), (3, _t('tools')[3]),
            (7, _t('tools')[4]), (8, _t('tools')[5]), (9, _t('tools')[6]), (10, _t('tools')[7]),
            (11, _t('tools')[8]), (13, _t('tools')[9]), (14, _t('tools')[10]), (15, _t('tools')[11])
        ]
    ...
    def draw(self, stdscr, colors):
        ...
        title = _t('toolbox_title')
        write_clipped_raw(stdscr, self.x + (self.w // 2) - (d_len(title) // 2), self.y, title, C_TB, self.x, self.w)
        curr_y = self.y + 1
        
        ttype, tname = self.tools[0]
        write_at(stdscr, self.x, curr_y, "│", C_TB)
        text = d_pad(tname, self.w - 2)
        write_clipped_raw(stdscr, self.x + 1, curr_y, text, C_ACTIVE if self.active_tool == ttype else C_TB, self.x+1, self.w-2)
...
def write_at(stdscr, x, y, text, attr=0):
    try: stdscr.addstr(y, x, str(text), attr)
    except curses.error: pass

def write_clipped_raw(stdscr, cx, cy, text, attr, min_x, max_w):
    curr_x = cx
    for c in str(text):
        cw = d_len(c)
        if min_x <= curr_x and curr_x + cw <= min_x + max_w:
            try: stdscr.addstr(cy, curr_x, c, attr)
            except curses.error: pass
        curr_x += cw
...
def draw_properties(stdscr, prop_win, selected_win, selected_ctrl_idx, editing_prop, edit_buffer, colors, tools):
    ...
    def draw_prop(ly, lbl, p_id, val_str):
        write_clipped_raw(stdscr, prop_win.x + 2, prop_win.y + ly, lbl, C_LABEL, prop_win.x + 1, prop_win.w - 2)
        if editing_prop == p_id:
            eb = edit_buffer + "_"
            display_text = eb[-12:] if len(eb) > 12 else d_pad(eb, 12)
        else:
            vs = str(val_str)
            display_text = vs[:12] if len(vs) > 12 else d_pad(vs, 12)
        write_clipped_raw(stdscr, prop_win.x + 12, prop_win.y + ly, display_text, C_TB, prop_win.x + 1, prop_win.w - 2)

    if selected_win is not None and selected_ctrl_idx >= 0:
        c = selected_win.controls[selected_ctrl_idx]
        tool_name = _t('ctrl_timer') if c.tool_type == 14 else tools.get_tool_name(c.tool_type).strip()
        write_clipped_raw(stdscr, prop_win.x + 2, prop_win.y + 2, _t('prop_type').format(tool_name), C_LABEL, prop_win.x + 1, prop_win.w - 2)
        write_at(stdscr, prop_win.x + 1, prop_win.y + 3, "─" * (prop_win.w - 2), C_BG)

        draw_prop(5, _t('prop_name'), 1, c.name_id)
        draw_prop(6, _t('prop_cap'), 2, c.caption)
        draw_prop(7, _t('prop_x'), 3, c.x)
        draw_prop(8, _t('prop_y'), 4, c.y)
        draw_prop(9, _t('prop_w'), 5, c.w)
        draw_prop(10, _t('prop_h'), 6, c.h)
        
        if c.tool_type in (1, 11): 
            write_clipped_raw(stdscr, prop_win.x + 2, prop_win.y + 11, _t('prop_val'), C_LABEL, prop_win.x + 1, prop_win.w - 2)
            mark = "X" if c.value else " "
            write_clipped_raw(stdscr, prop_win.x + 12, prop_win.y + 11, d_pad(f"[{mark}]", 12), C_TB, prop_win.x + 1, prop_win.w - 2)
        if c.tool_type == 2:
            draw_prop(11, _t('prop_items'), 8, ",".join(c.items))
            draw_prop(12, _t('prop_idx'), 9, str(c.list_index))
        if c.tool_type == 10:
            draw_prop(11, _t('prop_items'), 8, ",".join(c.items))
            draw_prop(12, _t('prop_idx'), 9, str(c.list_index))
            draw_prop(13, _t('prop_fg'), 12, str(getattr(c, 'fg_color', -1)))
            draw_prop(14, _t('prop_bg'), 13, str(getattr(c, 'custom_bg', -1)))
        if c.tool_type == 14: draw_prop(11, _t('prop_intrv'), 7, str(c.interval))
        if c.tool_type in (8, 15):
            draw_prop(11, _t('prop_value'), 7, getattr(c, 'value', 0))
            draw_prop(12, _t('prop_min'), 10, getattr(c, 'min_val', 0))
            draw_prop(13, _t('prop_max'), 11, getattr(c, 'max_val', 100))
        if c.tool_type == 13:
            draw_prop(11, _t('prop_hscroll'), 7, "[X]" if getattr(c, 'h_scroll', False) else "[ ]")
            draw_prop(12, _t('prop_vscroll'), 8, "[X]" if getattr(c, 'v_scroll', False) else "[ ]")
            draw_prop(13, _t('prop_syntaxhl'), 10, "[X]" if getattr(c, 'syntax_hl', False) else "[ ]")
            draw_prop(14, _t('prop_edit'), 11, "[X]" if getattr(c, 'editable', True) else "[ ]")
            draw_prop(15, _t('prop_fg'), 12, str(getattr(c, 'fg_color', -1)))
            draw_prop(16, _t('prop_bg'), 13, str(getattr(c, 'custom_bg', -1)))
        if c.tool_type == 3: 
            write_clipped_raw(stdscr, prop_win.x + 2, prop_win.y + 11, _t('prop_color'), C_LABEL, prop_win.x + 1, prop_win.w - 2)
            palette = [12, 13, 14, 15, 16, 17] 
            for p_idx, p_color in enumerate(palette):
                write_at(stdscr, prop_win.x + 12 + (p_idx * 2), prop_win.y + 11, "  ", curses.color_pair(p_color))
    elif selected_win is not None and selected_ctrl_idx == -1:
        w = selected_win
        write_clipped_raw(stdscr, prop_win.x + 2, prop_win.y + 2, _t('prop_type').format(_t('prop_form')), C_LABEL, prop_win.x + 1, prop_win.w - 2)
        write_at(stdscr, prop_win.x + 1, prop_win.y + 3, "─" * (prop_win.w - 2), C_BG)
        draw_prop(5, _t('prop_name'), 1, w.name_id)
        draw_prop(6, _t('prop_cap'), 2, w.title)
        draw_prop(7, _t('prop_x'), 3, w.x)
        draw_prop(8, _t('prop_y'), 4, w.y)
        draw_prop(9, _t('prop_w'), 5, w.w)
        draw_prop(10, _t('prop_h'), 6, w.h)
        draw_prop(11, _t('prop_pinned'), 7, "[X]" if w.pinned_topmost else "[ ]")
        draw_prop(12, _t('prop_resiz'), 8, "[X]" if w.resizable else "[ ]")
        draw_prop(13, _t('prop_hidden'), 9, "[X]" if w.hidden else "[ ]")
        draw_prop(14, _t('prop_fg'), 10, str(getattr(w, 'fg_color', -1)))
        draw_prop(15, _t('prop_bg'), 11, str(getattr(w, 'custom_bg', -1)))
    else:
        write_clipped_raw(stdscr, prop_win.x + 2, prop_win.y + 2, _t('prop_no_sel'), C_LABEL, prop_win.x + 1, prop_win.w - 2)
...
def handle_combobox_dropdown(stdscr, dx, dy, w, items, colors):
    ...
    while True:
        ...
        for r in range(h - 2):
            ...
            if idx < len(items):
                text = d_pad(items[idx], w - 2)
                attr = C_HL if idx == selected else C_BG
                write_clipped_raw(stdscr, dx + 1, dy + 1 + r, text, attr, dx + 1, w - 2)
            else:
        ...
        try:
            ch_raw = stdscr.get_wch()
            ch = ord(ch_raw) if isinstance(ch_raw, str) else ch_raw
...
def draw_msgbox(stdscr, msg, colors):
    C_BORDER, C_BG = colors['border'], colors['bg']
    lines = msg.split('\n')
    w = max([d_len(l) for l in lines] + [20]) + 4
    h = len(lines) + 4
    ...
    for i, l in enumerate(lines): write_clipped_raw(stdscr, x + 2, y + 2 + i, l, C_BG, x + 1, w - 2)
    btn = _t('me_ok')
    write_clipped_raw(stdscr, x + (w - d_len(btn) - 4) // 2, y + h - 2, f"[ {btn} ]", C_BORDER, x + 1, w - 2)
...
def handle_file_menu(stdscr, colors):
    C_BORDER, C_BG = colors['border'], colors['bg']
    menu_items = _t('menu_file')
    w = max(d_len(i) for i in menu_items) + 4
    h, x, y = len(menu_items) + 2, 1, 1
    write_at(stdscr, x, y, "┌" + "─" * (w - 2) + "┐", C_BORDER)
    for i, item in enumerate(menu_items):
        write_at(stdscr, x, y + i + 1, "│", C_BORDER)
        write_clipped_raw(stdscr, x + 1, y + i + 1, d_pad(item, w - 2), C_BG, x + 1, w - 2)
...
def handle_edit_menu(stdscr, colors):
    C_BORDER, C_BG = colors['border'], colors['bg']
    menu_items = _t('menu_edit')
    w = max(d_len(i) for i in menu_items) + 4
    h, x, y = len(menu_items) + 2, 7 + d_len(_t('menu_top').split('Edit')[0]), 1
    write_at(stdscr, x, y, "┌" + "─" * (w - 2) + "┐", C_BORDER)
    for i, item in enumerate(menu_items):
        write_at(stdscr, x, y + i + 1, "│", C_BORDER)
        write_clipped_raw(stdscr, x + 1, y + i + 1, d_pad(item, w - 2), C_BG, x + 1, w - 2)
...
def prompt_input(stdscr, prompt_title, colors):
    ...
    box_w, box_h = max(40, d_len(prompt_title) + 6), 5
    ...
    while True:
        ...
        write_clipped_raw(stdscr, box_x + (box_w - d_len(title))//2, box_y, title, C_BORDER, box_x, box_w)
        write_clipped_raw(stdscr, box_x + 2, box_y + 2, d_pad((buffer + "_"), box_w - 4), C_TB, box_x + 1, box_w - 2)
        stdscr.refresh()
        
        try:
            ch_raw = stdscr.get_wch()
            ch = ord(ch_raw) if isinstance(ch_raw, str) else ch_raw
            char_str = ch_raw if isinstance(ch_raw, str) else ""
        except AttributeError:
            ch = stdscr.getch()
            char_str = chr(ch) if 0 <= ch <= 255 else ""
        except curses.error:
            ch = -1
            char_str = ""
        ...
        elif isinstance(char_str, str) and char_str and char_str.isprintable() and ch != -1:
            if d_len(buffer) < box_w - 5: buffer += char_str
        time.sleep(0.01)

def menu_editor_loop(stdscr, form, colors):
    C_LABEL = colors['prop_label']
    me_win = Window(10, 5, 52, 16, _t('me_title'), "MenuEditor")
    me_win.resizable = False
    me_win.add_control(2, 3, 2, _t('me_sel'))
    me_win.controls[0].w = 46
    me_win.add_control(2, 6, 3, _t('me_add_top'))
    me_win.controls[1].w, me_win.controls[1].caption = 22, _t('me_add_top')
    me_win.add_control(26, 6, 3, _t('me_add_sub'))
    me_win.controls[2].w, me_win.controls[2].caption = 22, _t('me_add_sub')
    me_win.add_control(2, 10, 3, _t('me_del_sel'))
    me_win.controls[3].w, me_win.controls[3].caption = 22, _t('me_del_sel')
    me_win.add_control(26, 10, 3, _t('me_edit_code'))
    me_win.controls[4].w, me_win.controls[4].caption = 22, _t('me_edit_code')
    me_win.add_control(14, 13, 3, _t('me_close'))
    me_win.controls[5].w, me_win.controls[5].caption = 22, _t('me_ok')
    flat_list = []
    ...
    while True:
        ...
        write_clipped_raw(stdscr, me_win.x + 2, me_win.y + 2, _t('me_lbl_sel'), C_LABEL, me_win.x + 1, me_win.w - 2)
        stdscr.refresh()
                ...
                if left_click and not mouse_down:
                    ...
                    if pressed_ctrl >= 0:
                        if me_win.hit_test(mx, my) and me_win.hit_control(mx - me_win.x, my - me_win.y) == pressed_ctrl:
                            if pressed_ctrl == 1: 
                                lbl = prompt_input(stdscr, _t('me_p_top'), colors)
                                if lbl:
                                    nm = prompt_input(stdscr, _t('me_p_func'), colors)
                                    if nm:
                                ...
                                lbl = prompt_input(stdscr, _t('me_p_sub'), colors)
                                if lbl:
                                    nm = prompt_input(stdscr, _t('me_p_sfunc'), colors)
                                    if nm:
...
def run_gui(stdscr):
    ...
    sys._is_standalone_run = False 
    
    # FIX: Ensure _ide_dir gets the absolute path of the module directory instead of current working dir
    setattr(sys, '_ide_dir', os.path.dirname(os.path.abspath(__file__)))
    ...
    if getattr(sys, '_rad_dark_mode', False):
        C = {
    ...
    tools = Toolbox(0, 1)
    main_form = Window(17, 1, 41, 18, "", "Form1")
    prop_win = Window(48, 8, 26, 14, _t('prop_title'), "Properties")
    ...
    run_arg_file = getattr(sys, '_rad_run_file', None)
    design_arg_file = getattr(sys, '_rad_design_file', None)

    if run_arg_file:
        try:
            with open(run_arg_file, 'r', encoding='utf-8') as f: data = json.load(f)
            main_form = Window.from_dict(data)
            windows[0], design_backup = main_form, copy.deepcopy(main_form)
            run_mode, run_focused_ctrl = True, -1
            sys._is_standalone_run = True
            init_run_mode(main_form, run_globals)
        except Exception: pass
    elif design_arg_file:
        try:
            with open(design_arg_file, 'r', encoding='utf-8') as f: data = json.load(f)
            main_form = Window.from_dict(data)
            windows[0] = main_form
            CURRENT_PROJECT_FILE = design_arg_file
        except Exception: pass
    ...
    while True:
        ...
        if run_mode:
                ...
                if filepath:
                    ...
                    if mode == 'save':
                        ...
                        try:
                            ...
                            show_sync_msgbox(stdscr, _t('msg_saved').format(filepath), C)
                        except Exception as e: show_sync_msgbox(stdscr, _t('msg_save_err').format(e), C)
                    elif mode == 'load':
                        if not filepath.endswith('.json'): filepath += '.json'
                        try:
                            ...
                            CURRENT_PROJECT_FILE = filepath
                            show_sync_msgbox(stdscr, _t('msg_loaded').format(filepath), C)
                        except Exception as e: show_sync_msgbox(stdscr, _t('msg_load_err').format(e), C)
            ...
            if queued_form_to_load:
                ...
                try:
                    ...
                    stdscr.clear()
                    init_run_mode(main_form, run_globals)
                except Exception as e: run_globals['__msg__'] = _t('msg_load_err').format(e)
        ...
        if run_mode:
            write_at(stdscr, 0, 0, d_pad("", curses.COLS), C['handle'])
            menu_x = 1
            for m in main_form.menus:
                lbl = f" {m.label} "
                write_clipped_raw(stdscr, menu_x, 0, lbl, C['handle'], 0, curses.COLS)
                w_lbl = d_len(lbl)
                menu_positions.append((menu_x, menu_x + w_lbl, m))
                menu_x += w_lbl
                
            if not getattr(sys, '_is_standalone_run', False):
                stop_lbl = _t('menu_top_run')
                menu_x += 2
                write_clipped_raw(stdscr, menu_x, 0, stop_lbl, C['handle'], 0, curses.COLS)
                stop_pos = (menu_x, menu_x + d_len(stop_lbl))
            else:
                stop_pos = (0, 0)
        else:
            menu_str = _t('menu_top')
            write_clipped_raw(stdscr, 0, 0, d_pad(menu_str, curses.COLS), C['handle'], 0, curses.COLS)
        ...
        if run_mode and run_focused_ctrl >= 0 and not main_form.hidden and main_form.controls[run_focused_ctrl].tool_type == 13:
            ...
            lines = c.caption.split('\n')
            if not lines: lines = [""]
            cy = min(c.cursor_y, len(lines) - 1)
            cx = min(c.cursor_x, len(lines[cy]))
            
            display_x_offset = d_len(lines[cy][:cx]) - d_len(lines[cy][:c.scroll_x])
            screen_cx = main_form.x + c.x + display_x_offset
            screen_cy = main_form.y + c.y + (cy - c.scroll_y)
            
            if (0 <= display_x_offset < vw) and (0 <= cy - c.scroll_y < vh):
                ...
                if scroll_up or scroll_down:
                    ...
                    if not mouse_down:
                        ...
                        if run_mode:
                                    ...
                                    if start_x <= mx < end_x:
                                        ...
                                        while curr_m:
                                            if curr_m.sub:
                                                ...
                                                drop_w = max(15, max([d_len(i) for i in drop_items]) + 2)
                                ...
                                if not win.hidden and win.hit_test(mx, my):
                                    ...
                                    if lx == win.w - 1 and ly == win.h - 1 and left_click and win.resizable:
                                        ...
                                        if idx >= 0:
                                            ...
                                            if right_click:
                                                if c.tool_type == 13:
                                                    action = handle_combobox_dropdown(stdscr, mx, my, 15, [_t('ctx_copy'), _t('ctx_paste'), _t('ctx_sel_all')], C)
                                                    if action == 0: 
                                                ...
                                                if c.tool_type == 13:
                                                    ...
                                                    if c.v_scroll and click_x == c.w - 1 and click_y < vh:
                                                        ...
                                                        target_disp_x = c.scroll_x + click_x
                                                        curr_disp = 0
                                                        c.cursor_x = 0
                                                        for char in lines[c.cursor_y]:
                                                            cw = d_len(char)
                                                            if curr_disp + cw > target_disp_x: break
                                                            curr_disp += cw
                                                            c.cursor_x += 1
                            ...
                            mt = _t('menu_top')
                            mt_file_w = d_len(mt.split('Edit')[0]) if 'Edit' in mt else d_len(mt.split('Editar')[0] if 'Editar' in mt else mt.split('編集')[0])
                            mt_edit_w = d_len(mt.split('[RUN')[0]) if '[RUN' in mt else d_len(mt.split('[EJECUTAR')[0] if '[EJECUTAR' in mt else mt.split('[実行')[0])
                            mt_run_w = d_len(mt.split(']')[0]) + 1
                            mt_menu_w = d_len(mt)

                            if not clicked_handled and 1 <= mx <= mt_file_w and my == 0:
                                ...
                                if choice == 'save':
                                    if CURRENT_PROJECT_FILE:
                                        try:
                                            ...
                                            show_sync_msgbox(stdscr, _t('msg_saved').format(CURRENT_PROJECT_FILE), C)
                                        except Exception as e: show_sync_msgbox(stdscr, _t('msg_save_err').format(e), C)
                                    else:
                                        choice = 'save_as' 
                                if choice == 'save_as':
                            ...
                            elif not clicked_handled and mt_file_w <= mx <= mt_edit_w and my == 0:
                            ...
                            elif not clicked_handled and mt_edit_w <= mx <= mt_run_w and my == 0:
                                design_backup, run_mode, run_focused_ctrl = copy.deepcopy(main_form), True, -1
                                stdscr.clear()
                                init_run_mode(main_form, run_globals)
                                clicked_handled = True

                            elif not clicked_handled and mt_run_w <= mx <= mt_menu_w and my == 0:
                                                ...
                                                if selected_ctrl_idx >= 0 and selected_win is not None:
                                                    ...
                                                    if prop_local_y == 5: editing_prop, edit_buffer = 1, c.name_id
                                                        ...
                                                        if c.tool_type in (1, 11): c.value, clicked_prop_row = not c.value, False 
                                                            ...
                                                            block_idx, palette = (local_x - 12) // 2, [12, 13, 14, 15, 16, 17]
            ...
            if run_mode:
                if run_focused_ctrl >= 0:
                    ...
                    if c.tool_type == 13: 
                            ...
                            if ch == 9:
                                ...
                                if not delete_selection(c):
                                    if c.cursor_x > 0:
                                        ...
                                        c.cursor_x = prev_len
                                        c.caption = "\n".join(lines)
                            elif isinstance(char_str, str) and char_str and char_str.isprintable():
                                delete_selection(c)
                                lines = c.caption.split('\n')
                                lines[c.cursor_y] = lines[c.cursor_y][:c.cursor_x] + char_str + lines[c.cursor_y][c.cursor_x:]
                                c.cursor_x += 1
                                c.caption = "\n".join(lines)
                        ...
                        str_disp_w_cursor = d_len(lines[c.cursor_y][:c.cursor_x])
                        str_disp_w_scroll = d_len(lines[c.cursor_y][:c.scroll_x])
                        
                        if str_disp_w_cursor < str_disp_w_scroll:
                            c.scroll_x = c.cursor_x
                        elif str_disp_w_cursor >= str_disp_w_scroll + vw:
                            temp_scroll = c.cursor_x
                            while temp_scroll >= 0 and d_len(lines[c.cursor_y][temp_scroll:c.cursor_x]) < vw: temp_scroll -= 1
                            c.scroll_x = temp_scroll + 1
                ...
                if editing_prop == 0 and selected_win is not None:
                    ...
                    if ch in (8, 127, curses.KEY_BACKSPACE) or (isinstance(char_str, str) and char_str and char_str.isprintable()): editing_prop, edit_buffer = 2, target_cap
                
                if editing_prop > 0:
                    if ch in (10, 13, curses.KEY_ENTER): commit_edit()
                    elif ch in (8, 127, curses.KEY_BACKSPACE): edit_buffer = edit_buffer[:-1]
                    elif isinstance(char_str, str) and char_str and char_str.isprintable():
                        if editing_prop >= 3 and not (char_str.isdigit() or char_str == '-'): pass 
                        else: edit_buffer += char_str
        time.sleep(0.01)
...
def cli_entry():
    ...
    parser.add_argument("-jp", action="store_true", help="Start in Japanese")
    parser.add_argument("-es", action="store_true", help="Start in Spanish")
    parser.add_argument("design_file", nargs="?", help="Path to JSON to load in design mode")
    args, _ = parser.parse_known_args()
    
    if args.jp: LANG = 'jp'
    elif args.es: LANG = 'es'
    else: LANG = 'en'
    
    setattr(sys, '_rad_run_file', args.run)
    setattr(sys, '_rad_dark_mode', args.dark_mode)
    setattr(sys, '_rad_design_file', args.design_file)
